...
class About extends React.Component {
    ...
    render() {
        ...
        return(
            ...
            <p>There are a lot of services that take care of the legal aspects of the end of a person's life, but many people don't think about the importance of reflecting on their lives and expressing personal messages to those they love.</p>
            <p>That's where we come in.</p>

            <p>Inspired by <a href="https://med.stanford.edu/letter/friendsandfamily.html">The Stanford Letter Project</a>, we wanted to create an easy way to create messages to those you love which will be dsitributed in the event you pass away, so nothing important gets left unsaid.</p>
            <p>Death is not somethig anyone wants to think about, but as Standford puts it:</p>
